...
// Dữ liệu lịch học
const schedule = [
  { id: 1, date: '2025-01-17', time: '10:30-11:30', subject: 'Lập trình hướng đối tượng', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Đã đổi lịch. Lý do: ngủ', meetingType: '1-1', onlineMeeting: true, meetingLink: 'https://teams.microsoft.com/l/meetup-join/example1', courseStatus: 'Sắp tới' },
  { id: 2, date: '2024-01-22', time: '19:00-20:00', subject: 'Lập trình hướng đối tượng', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Thiết kế giao diện và trừu tượng', meetingType: '1-1', onlineMeeting: true, meetingLink: 'https://teams.microsoft.com/l/meetup-join/example4', courseStatus: 'Đang thực hiện' },
  { id: 3, date: '2024-01-24', time: '08:00-09:00', subject: 'Cấu trúc dữ liệu', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Học về danh sách liên kết và cây', meetingType: '1-1', onlineMeeting: true, meetingLink: 'https://teams.microsoft.com/l/meetup-join/example5', courseStatus: 'Kết thúc' },
  { id: 4, date: '2024-01-26', time: '10:00-11:00', subject: 'Phân tích thiết kế hệ thống', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Học về UML và use case', meetingType: '1-1', onlineMeeting: true, meetingLink: 'https://teams.microsoft.com/l/meetup-join/example6', courseStatus: 'Mở đăng ký' },
  { id: 5, date: '2024-01-28', time: '13:00-14:00', subject: 'Mạng máy tính', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Học về TCP/IP và mô hình OSI', meetingType: '1-1', onlineMeeting: true, meetingLink: 'https://teams.microsoft.com/l/meetup-join/mangmaytinh', courseStatus: 'Đã đăng ký (bởi Ngô Minh Học)' },
  { id: 6, date: '2024-02-02', time: '09:00-10:00', subject: 'Triết học Mác-Lênin', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: '', meetingType: '1-1', onlineMeeting: true, meetingLink: '', courseStatus: 'Chưa bắt đầu' },
  { id: 7, date: '2024-02-05', time: '15:00-16:00', subject: 'Kinh tế vĩ mô', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: '', meetingType: '1-1', onlineMeeting: true, meetingLink: '', courseStatus: 'Chưa bắt đầu' },
  { id: 11, date: '2025-02-10', time: '10:00-11:00', subject: 'A', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Môn học thử nghiệm', meetingType: '1-1', onlineMeeting: true, meetingLink: '', courseStatus: 'Chưa bắt đầu' },
  { id: 8, date: '2025-01-20', time: '14:00-15:00', subject: 'Lập trình Java', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Học về Collections và Generics', meetingType: '1-1', onlineMeeting: false, meetingLink: '', courseStatus: 'Sắp tới' },
  { id: 9, date: '2025-01-25', time: '09:00-10:00', subject: 'Thuật toán', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Học về thuật toán sắp xếp', meetingType: '1-1', onlineMeeting: true, meetingLink: 'https://meet.google.com/abc-defg-hij', courseStatus: 'Sắp tới' },
  { id: 10, date: '2025-01-30', time: '16:00-17:00', subject: 'Lập trình C++', tutor: 'Trần Minh Khoa', status: 'upcoming', notes: 'Học về con trỏ và tham chiếu', meetingType: '1-1', onlineMeeting: true, meetingLink: 'https://meet.google.com/xyz-uvw-123', courseStatus: 'Sắp tới' }
];
